...
const MARKET_TIPS = {
  ...
  '코스피': {
    def: '한국거래소(KRX)의 대표 주가지수입니다. 유가증권시장에 상장된 기업을 시가총액 가중 방식으로 산출하며, 삼성전자·SK하이닉스·현대차 등 대형 수출 기업이 큰 비중을 차지합니다.',
    current: '2026년 기준, 코스피는 반도체 사이클 둔화, 원화 약세, 외국인 수급 불안으로 2,500~2,700 구간에서 박스권을 형성 중입니다. 미국 관세 정책과 중국 경기 회복 여부가 핵심 변수입니다.',
    context: '2,000 미만: 침체 우려 | 2,000~2,500: 약세 | 2,500~3,000: 정상 범위 | 3,000 이상: 강세. 외국인 지분율과 환율 흐름이 단기 방향성에 큰 영향을 미칩니다.',
    implication: '원화 약세 구간에서는 외국인 매도 압력이 커질 수 있습니다. 반대로 달러 약세 전환 시 외국인 복귀로 빠른 반등이 나타나는 경향이 있습니다.',
    warn: '코스피는 미국 증시, 중국 경기, 반도체 사이클에 동시에 민감합니다. 개별 변수보다 3가지를 함께 모니터링하는 것이 중요합니다.'
  },
  '코스닥': {
    def: '한국거래소의 중소·기술주 중심 주가지수입니다. 바이오·IT·게임 등 성장 기업이 많아 코스피보다 변동성이 크며, 금리 변화와 위험 선호 심리에 더 민감하게 반응합니다.',
    current: '2026년 기준, 코스닥은 바이오주 규제 리스크와 중소기업 자금조달 부담으로 700~800 구간에서 약세를 보이고 있습니다. 금리 인하 기대가 약해지면 성장주 중심의 코스닥 반등도 지연됩니다.',
    context: '700 미만: 약세 구간 | 700~900: 정상 | 900~1,000: 강세. 코스피 대비 코스닥 상대강도는 위험 선호 심리의 선행 지표로 활용할 수 있습니다.',
    implication: '코스닥이 코스피보다 먼저 반등하면 위험 선호 심리 회복의 신호로 해석됩니다. 반대로 코스닥이 먼저 무너지면 시장 심리 악화의 선행 신호일 수 있습니다.',
    warn: '코스닥은 유동성이 낮아 급등락이 잦습니다. 단기 노이즈보다는 주간·월간 추세와 거래대금 흐름을 함께 확인하세요.'
  },
};
